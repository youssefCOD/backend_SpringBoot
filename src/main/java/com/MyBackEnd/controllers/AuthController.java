...
public class AuthController {
        ...
        public ResponseEntity<AuthResponse> login(@RequestBody LoginRequest loginRequest) {
                ...
                // set user object :
                final MyCustomUserDetails userDetails = (MyCustomUserDetails) myCustomUserDetailsService
        ...
        public ResponseEntity<RegistrationResponse> register(@RequestParam("first_name") String firstName,
                ...
                if (createdUser == null) {
                        RegistrationResponse errorResponse = new RegistrationResponse("Something went wrong",
                                        "failure");
                ...
                // so that we can rature a json(tabrkalah makontch 3araf tsa7bli radi traj3lihom
                // l7ammas)
                // * */ Old code
                // * */ RegistrationResponse successResponse = new
                // RegistrationResponse("Registration Successful.", "success");
